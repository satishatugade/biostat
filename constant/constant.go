...
const (
	...
	RemoveRelativeRequest = "/remove/relative/request"
	RemoveRelativeConfirm = "/remove/relative/confirm"
	...
	MigrateToBioMail        = "/migrate-biomail"
...
const (
	...
	OTPPurposeRemoveFamily   = "REMOVE_FAMILY"
	OTPPurposeAccessDocument = "ACCESS_DOCUMENT"

	OTPIdentityEmail = "EMAIL"
	OTPIdentityPhone = "PHONE"
	OTPIdentityUser  = "USER_ID"
